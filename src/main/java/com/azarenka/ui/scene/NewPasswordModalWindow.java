 ...
 */
@Component
public class NewPasswordModalWindow extends CommonWidget implements IFxmlWindow {

    @Value("classpath:fxml/new-password-modal-window.fxml")
    private Resource resource;
    private Scene scene;

    public NewPasswordModalWindow(ApplicationContext applicationContext) {
